...
if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
    ...
    echo json_encode(['error' => 'Unauthorized access. Admin authentication required.']);
    exit;
}
...
function createPurchase() {
    ...
    if (isset($data['items'])) {
        ...
        $sql = "INSERT INTO purchases (
            supplier, supplier_phone, gst_no, city,
            items, total_items,
        ...
        $sql = "INSERT INTO purchases (
            supplier, supplier_phone, supplier_email, gst_no, city,
