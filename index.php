...
<body>
        ...
        <div class="container">
            ...
            <div class="category-grid">
                <div class="category-card">
                    ...
                    <h3>Round</h3>
                    <a href="round.html" class="explore-link">Explore</a>
                </div>
                <div class="category-card">
                    <div class="placeholder-img category-placeholder">
                        <div class="eyeglass-img">
                    ...
                    <h3>Cat-Eye</h3>
                    <a href="cat-eye.html" class="explore-link">Explore</a>
                </div>
                <div class="category-card">
                    <div class="placeholder-img category-placeholder">
                        <div class="eyeglass-img">
                    ...
                    <h3>Clubmaster</h3>
                    <a href="clubmaster.html" class="explore-link">Explore</a>
                </div>
                <div class="category-card">
                    <div class="placeholder-img category-placeholder">
                        <div class="eyeglass-img">
                    ...
                    <h3>Transparent</h3>
                    <a href="transparent.html" class="explore-link">Explore</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div id="wishlistSidebar" style="position: fixed; top: 0; right: -400px; width: 400px; height: 100vh; background: white; box-shadow: -2px 0 10px rgba(0,0,0,0.3); z-index: 10001; transition: right 0.3s ease;">
        ...
        <div id="wishlistItems" style="flex: 1; overflow-y: auto; padding: 20px; height: calc(100vh - 80px);">
