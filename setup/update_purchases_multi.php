...
echo "<br><a href='../admin/admin-pages/admin.php#purchases' style='background: #00bac7; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Go to Admin Panel</a>";
?>
