...
<body>
    ...
    <script src="../js/admin-script-new.js"></script>
    <script src="../js/admin-purchases-enhanced.js"></script>
    <script>
            ...
            if (logoutBtn) {
                logoutBtn.addEventListener('click', async function(e) {
                    ...
                    if (confirm('Are you sure you want to logout?')) {
                        try {
                            const response = await fetch('../api/api_admin_auth.php?action=logout', {
                                method: 'POST',
                                credentials: 'include'
                            });
