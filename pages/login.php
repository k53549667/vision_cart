...
<body>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('../api/api_auth.php?action=login', {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('forgotPasswordLink').addEventListener('click', async (e) => {
            ...
            try {
                const response = await fetch('../api/api_auth.php?action=forgot-password', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
        ...
        window.addEventListener('DOMContentLoaded', async () => {
            try {
                const response = await fetch('../api/api_auth.php?action=check-session');
                const data = await response.json();
