...
/**
 * Products API
 * GET operations are public, POST/PUT/DELETE require admin auth
 */

// Start session for auth check on write operations
session_start();
...
function requireAdminAuth() {
    if (!isset($_SESSION['admin_logged_in']) || $_SESSION['admin_logged_in'] !== true) {
        ...
        echo json_encode(['error' => 'Admin authentication required for this operation']);
        exit;
    }
}
...
switch ($method) {
    ...
    case 'POST':
        // POST operations require admin auth
        requireAdminAuth();
        if ($action === 'create') {
            createProduct();
    ...
    case 'DELETE':
        // DELETE operations require admin auth
        requireAdminAuth();
        if (isset($_GET['id'])) {
